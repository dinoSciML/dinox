...
parser.add_argument('-data_dir', '--data_dir', type=str, default='..//data/', help="Where to save")
...
parser.add_argument('-ndata', '--ndata', type=int, default=200, help="Number of samples")
...
if args.basis_type.lower() == 'as':
	...
	PhiTJ_data = np.transpose(JTPhi_data['JTPhi_data'], (0,2,1))[:args.ndata]
