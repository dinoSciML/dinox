...
parser.add_argument(
    "-num_epochs", "--num_epochs", type=int, default=200, help="How many epochs"
)
parser.add_argument(
...
for epoch in range(1, args.num_epochs):
    ...
    print(
        "Max test accuracy = ", 100 * np.max(np.array(metrics_history["test_accuracy"]))
    )
